...
namespace MR_SFML
{
	class Player_Platformer_SFML : public Player_SFML
	{
	public:
		/// <summary>
		...
		Player_Platformer_SFML(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float speed, float jumpHeight);
		...
		Player_Platformer_SFML(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float speed, float jumpHeight, sf::Vector2f playerSize, sf::Vector2f playerPos);

		/// <summary>
		/// [Destructor] Cleans up the class.
		/// </summary>
		~Player_Platformer_SFML();
		...
		void OnCollision(sf::Vector2f direction); // TODO: Maybe move this function to base class.
	...
	protected:
		...
		/// <summary>
		/// Handle player's jumping functionality.
		/// </summary>
		void Handle_PlayerJump();
